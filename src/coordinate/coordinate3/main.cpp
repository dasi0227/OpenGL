...
int main(){
  ...
  // 自定义着色器和数据
  Shader myShader("src/coordinate/coordinate3/vshader.txt","src/coordinate/coordinate3/fshader.txt");
  float vertices[] = {
  ...
  while (!glfwWindowShouldClose(window)) {
    ...
    projection = perspective(radians(60.0f), float(0.5), 0.1f, 100.0f);
